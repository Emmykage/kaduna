...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Link your bank account or card securely. We use bank-level encryption to protect your data.',
      color: 'emerald'
    },
    {
      icon: CheckCircle,
      title: 'Start Transacting',
      description: 'Make payments, transfer money, or set up escrow services instantly. It\'s that simple!',
      color: 'purple'
    }
  ];
  ...
  return (
    <section id="how-it-works" className="py-20 px-4 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto">
        ...
        >
          <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wide">How It Works</span>
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 h-full">
                  <div className="flex flex-col items-center text-center">
                    <div className={`w-20 h-20 rounded-full bg-gradient-to-br from-${step.color}-400 to-${step.color}-600 flex items-center justify-center mb-6 relative`}>
